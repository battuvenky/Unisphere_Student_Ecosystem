...
export async function POST(request: Request, context: Context) {
  ...
  try {
    ...
    let notificationTitle = "New comment on your answer";
    let notificationMessage = `${user.profile.fullName} commented on your answer.`;
    ...
    console.error("Create answer comment API error", error);
